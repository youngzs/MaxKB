...
-Ensure that the optimized problem accurately reflects the original problem intent and does not alter the original intention.`,
    ...
    docxRender: {
      title: 'DOCX Render',
      subtitle: 'Render an output document from a docx template and placeholder values',
      templateKey: 'Template OSS Key',
      templateKeyPlaceholder: 'Enter the template file OSS key (File.id)',
      values: 'Placeholder Values',
      valuesPlaceholder: 'Enter a JSON object, e.g. {"name": "World"}',
      valuesInvalid: 'Placeholder values must be a valid JSON object',
      outputFilename: 'Output Filename',
      outputFilenamePlaceholder: 'output.docx',
      outputOssKey: 'Output OSS Key',
      error: 'Error',
    },
    zipPack: {
      title: 'ZIP Pack',
      subtitle: 'Bundle multiple documents into a single zip archive',
      documentKeys: 'Document OSS Keys',
      documentKeysPlaceholder: 'One OSS key (File.id) per line',
      documentKeysRequired: 'Please provide at least one document OSS key',
      documentNames: 'Document Names (optional)',
      documentNamesPlaceholder: 'One name per line, aligned by row with OSS keys; blanks use defaults',
      itemFolders: 'Item Folders (optional)',
      itemFoldersPlaceholder: 'One folder name per line, aligned by row with OSS keys; blank means flat layout',
      archiveName: 'Archive Filename',
      archiveNamePlaceholder: 'materials.zip',
      outputOssKey: 'Output OSS Key',
      includedCount: 'Included File Count',
