...
class _PlaceholderItemSerializer(serializers.Serializer):
    ...
    type = serializers.ChoiceField(choices=("text", "long_text", "number", "date", "enum"), default="text")
    required = serializers.BooleanField(default=False)
    ai_hint = serializers.CharField(allow_blank=True, default="", required=False)
    enum_options = serializers.ListField(child=serializers.CharField(), default=list, required=False)
...
class DocumentTemplateUploadSerializer(serializers.Serializer):
    ...
    scenario = serializers.ChoiceField(choices=TemplateScenario.choices, default=TemplateScenario.OTHER)
...
class DocumentTemplateUpdateSerializer(serializers.Serializer):
    ...
    scenario = serializers.ChoiceField(choices=TemplateScenario.choices, required=False)
    is_active = serializers.BooleanField(required=False)
    placeholders = serializers.ListField(child=_PlaceholderItemSerializer(), required=False)
