...
from knowledge.models import (Document, Paragraph, Knowledge, Tag, DocumentTag,
                              FinancialStatement, FinancialFact)
...
_NAME_PAIRS = [
    ('资产负债表', '财务', '资产负债表'), ('利润', '财务', '利润表'),
    ('现金流量', '财务', '现金流量表'), ('科目明细', '财务', '科目明细'),
    ('审计报告', '财务', '审计报告'), ('财务报表', '财务', '财务报表'),
    ('财报', '财务', '财务报表'), ('反担保', '担保', '反担保'), ('担保', '担保', '担保'),
    ('征信', '征信', '征信报告'), ('营业执照', '工商', '营业执照'),
    ('开户许可', '工商', '开户许可证'), ('章程', '工商', '公司章程'),
    ('公司简介', '企业', '公司简介'), ('简介', '企业', '公司简介'),
    ('简历', '企业', '人员简历'), ('身份证', '企业', '身份证'),
]
# doc_type 标签值 → 类别
_DOCTYPE_CATEGORY = {
    '财务报表': '财务', '审计报告': '财务',
    '营业执照': '工商', '公司章程': '工商', '开户许可证': '工商',
    '征信报告': '征信', '身份证': '企业', '人员简历': '企业', '公司简介': '企业',
    '担保': '担保', '反担保': '担保',
}
...
def _doc_type_of(knowledge_id, document_id):
    ...
    tag_ids = list(QuerySet(Tag).filter(knowledge_id=knowledge_id, key='doc_type')
    ...
    for d in documents:
        try:
            ...
            maxkb_logger.warning(
                f'[enrich] inject title failed doc={getattr(d, "id", None)}: {e}')
    return changed
